...
Добавим новые текстуры, они должны распологаться в папке *terrain-atlas* ресурсов. Также как и в случае предмета, мы должны указывать мету, а в качестве названия текстуры будет использовано оставшееся имя файла без пути.
