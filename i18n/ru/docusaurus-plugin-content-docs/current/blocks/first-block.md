...
Рассмотрите [SpecialType](/api/namespace/Block#SpecialType) для получения полной и актуальной информации по поводу доступности определенных свойств, статьи обновляются по мере необходимости.
