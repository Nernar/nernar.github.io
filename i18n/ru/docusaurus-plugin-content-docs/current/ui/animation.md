...
Появление достижений из Java издания игры и изучений из [Ancient Wonders](https://github.com/Reider745/AncientWonders/blob/main/core/dev/core/ScrutinyAPI_v2.js#L444C1-L537C2) и [Infinite Forest](https://github.com/ArtemKot4/libraries/blob/main/dev/Notification/AchievementNotification.ts) тоже имеет свою анимацию. Или, например, более [сложная](https://github.com/ArtemKot4/FFManager/blob/main/code/BalanceOverlay.ts) анимация.
