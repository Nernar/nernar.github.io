...
Каждый метод здесь равносилен друг другу. Используя пространства имен (а также именные идентификаторы), мы дополнительно можем указать еще и событие (состояние) для призыва:
