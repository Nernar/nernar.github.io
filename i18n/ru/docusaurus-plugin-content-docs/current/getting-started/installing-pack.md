...
Для использования Inner Core нужен лаунчер, он позволит производить манипуляции с играми, модифицировать их соответственно. Также понадобится любое устройство на Android, важно иметь хотя бы несколько гигабайт ОЗУ за плечами и такое же количество свободного места в хранилище, слабый процессор тоже не подойдет. Начните с [определения версии](https://lumpics.ru/how-find-out-version-of-android-on-phone/) вашего устройства — это нужно для установки лаунчера правильной версии.
