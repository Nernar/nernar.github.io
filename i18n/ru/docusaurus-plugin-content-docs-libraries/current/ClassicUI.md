...
Classic UI — это мод-библиотека, изменяющая интерфейс блоков из модов на классический. Последняя актуальная версия библиотеки доступна к загрузке в [браузере модов](https://icmods.mineprogramming.org/mod?id=884).
